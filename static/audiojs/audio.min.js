(function(h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            createPlayer: {
                markup: '<div class="play-pause">             <p class="play"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <strong class="played">00:00</strong>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
